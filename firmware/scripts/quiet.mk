# code for the  quiet make file
# written by Prerna Baranwal 
# modified from analog devices 
####################################################################################
...
ifneq ($(VERBOSE),1)
  ...
  # Run - Load the bitstream onto the FPGA
  # $(1): Files to run
  # $(2): Textural description of the task
  # right now this is placehoolder and has the same function as clean
  define run
	@echo "Running $(strip $(2)) ..."
  -rm -rf $(strip $(1))
  endef

  define prereqs
	@echo "Sourcing Vivado environment for $(strip $(2)) ..."
  @. $(strip $(1))
  endef
else
  define build
